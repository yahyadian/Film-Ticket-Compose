...
import com.yahya.filmticket.ui.components.CartItem
...
fun CartContent(
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(state.orderFilmTicket, key = { it.filmTicket.id }) { item ->
                CartItem(
                    filmTicketId = item.filmTicket.id,
                    image = item.filmTicket.image,
                    title = item.filmTicket.title,
                    totalPrice = item.filmTicket.requiredPrice * item.count,
                    count = item.count,
        ...
        OrderButton(
            ...
            enabled = state.orderFilmTicket.isNotEmpty(),
            onClick = {
